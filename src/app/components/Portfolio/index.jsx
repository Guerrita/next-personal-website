...
const Portfolio = () => {
  return (
    ...
    <article className='grid grid-cols-2 gap-20 p-14 border-4 border-solid rounded-4xl article-height mb-10 sticky top-48 z-0 bg-primary'>
      <div>
    ...
    <article className='grid grid-cols-2 gap-20 p-14 border-4 border-solid rounded-4xl article-height mb-10 sticky top-48 z-10 bg-primary'>
      <div>
